...
class ContextPrecisionPrompt(PydanticPrompt[QAC, Verification]):
    ...
    instruction: str = """Given question, answer and context verify if the context was useful in arriving at the given answer. Give verdict as "1" if useful and "0" if not as well as a reason with json output. Make sure single quotes are used to portray quotes within the content of the reason field. """
    input_model = QAC
