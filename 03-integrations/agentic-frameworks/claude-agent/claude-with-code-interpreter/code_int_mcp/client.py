...
class CodeInterpreterClient:
    ...
    def _invoke_code_interpreter(self, operation: str, args: dict = None, code_int_session_id : str = "") -> CodeIntExecutionResult:
    ...
    def execute_code(self, code: str, language: str = "python", code_int_session_id : str ="") -> CodeIntExecutionResult:
