...
@tool("execute_code", "Execute code using Code Interpreter.", {"code": str, "language": str, "code_int_session_id" : str})
async def execute_code(args: dict[str, Any]) -> dict[str, Any]:
    result = client.execute_code(args.get('code'), args.get('language', 'python'), args.get('code_int_session_id', ''))
...
@tool("execute_command", "Execute command using Code Interpreter. ",{"command": str, "code_int_session_id" : str})
...
@tool("write_files", "Execute command using Code Interpreter. ",{"files_to_create": list, "code_int_session_id" : str})
...
@tool("read_files", "Execute command using Code Interpreter. ",{"paths": list, "code_int_session_id" : str})
