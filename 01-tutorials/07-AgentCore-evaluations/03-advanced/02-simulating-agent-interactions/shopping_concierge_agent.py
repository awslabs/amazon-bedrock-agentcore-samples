...
# ---------------------------------------------------------------------------
PRODUCTS = {
    "PROD-001": {"name": "Wireless Noise-Cancelling Headphones", "category": "Electronics",
                 "price": 79.99, "rating": 4.5, "stock": 15,
                 "description": "Over-ear headphones with 30hr battery, active noise cancellation."},
    "PROD-002": {"name": "Running Shoes (Size 10)", "category": "Footwear",
                 "price": 89.99, "rating": 4.3, "stock": 8,
                 "description": "Lightweight trail running shoes, breathable mesh upper."},
    "PROD-003": {"name": "Stainless Steel Water Bottle 32oz", "category": "Kitchen",
                 "price": 24.99, "rating": 4.7, "stock": 50,
                 "description": "Vacuum insulated, keeps cold 24h / hot 12h. BPA-free."},
    "PROD-004": {"name": "Yoga Mat Premium 6mm", "category": "Sports",
                 "price": 34.99, "rating": 4.6, "stock": 20,
                 "description": "Non-slip surface, extra thick 6mm cushioning, carrying strap included."},
    "PROD-005": {"name": "USB-C Hub 7-in-1", "category": "Electronics",
                 "price": 45.99, "rating": 4.2, "stock": 30,
                 "description": "4K HDMI, 100W PD, 2x USB-A 3.0, SD/MicroSD, USB-C data."},
    "PROD-006": {"name": "Cotton Crew-Neck T-Shirt (L)", "category": "Clothing",
                 "price": 19.99, "rating": 4.4, "stock": 100,
                 "description": "100% organic cotton, preshrunk, available in 12 colors."},
    "PROD-007": {"name": "Smart LED Desk Lamp", "category": "Home",
                 "price": 39.99, "rating": 4.5, "stock": 25,
                 "description": "Touch dimmer, 5 color temps, USB charging port, memory function."},
    "PROD-008": {"name": "Coffee Grinder Burr Electric", "category": "Kitchen",
                 "price": 54.99, "rating": 4.6, "stock": 12,
                 "description": "Conical burr, 18 grind settings, 60g hopper, quiet motor."},
    "PROD-009": {"name": "Resistance Bands Set (5 levels)", "category": "Sports",
                 "price": 22.99, "rating": 4.4, "stock": 40,
                 "description": "Natural latex, 10-50 lb resistance levels, includes carry bag."},
    "PROD-010": {"name": "Mechanical Keyboard TKL", "category": "Electronics",
                 "price": 129.99, "rating": 4.7, "stock": 10,
...
# Mock orders
_orders = {
    "ORD-SC-001": {"status": "delivered", "items": [{"product_id": "PROD-001", "qty": 1}],
                   "total": 79.99, "delivered": "2026-04-08"},
    "ORD-SC-002": {"status": "in_transit", "items": [{"product_id": "PROD-003", "qty": 2}],
                   "total": 49.98, "est_delivery": "2026-04-14",
                   "tracking": "1Z999AA1012345678"},
    "ORD-SC-003": {"status": "processing", "items": [{"product_id": "PROD-007", "qty": 1},
                                                       {"product_id": "PROD-006", "qty": 2}],
                   "total": 79.97, "placed": "2026-04-10"},
}
...
def track_shipment(order_id: str) -> str:
    ...
    return (f"Tracking for {order_id}: {tracking}\n"
