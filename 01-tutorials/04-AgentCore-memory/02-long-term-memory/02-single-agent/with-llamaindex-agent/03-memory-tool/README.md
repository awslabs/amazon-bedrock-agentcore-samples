...
|---|---|---|
| `academic-research-assistant-long-term-memory-tutorial.ipynb` | Academic research | Research evolution, grant-proposal support over months |
| `legal-document-analyzer-long-term-memory-tutorial.ipynb` | Legal | Multi-case precedent tracking, 12-month retention |
| `medical-knowledge-assistant-long-term-memory-tutorial.ipynb` | Medical | Longitudinal patient care, treatment outcomes |
| `investment-portfolio-advisor-long-term-memory-tutorial.ipynb` | Finance | Multi-quarter performance tracking |
