...
End-to-end walkthrough of AgentCore Memory using only `aws bedrock-agentcore-control` (control plane) and `aws bedrock-agentcore` (data plane) commands. The [boto3](./04-quickstart-boto3.ipynb) and [AgentCore SDK](./05-quickstart-agentcore-sdk.ipynb) quickstarts cover the same flow.
