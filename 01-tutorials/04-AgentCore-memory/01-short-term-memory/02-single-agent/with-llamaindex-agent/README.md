...
|---|---|---|
| `academic-research-assistant-short-term-memory-tutorial.ipynb` | Academic research | Paper tracking, cross-reference within a session |
| `legal-document-analyzer-short-term-memory-tutorial.ipynb` | Legal | Contract analysis, risk assessment |
| `medical-knowledge-assistant-short-term-memory-tutorial.ipynb` | Medical | Patient consultation, drug interactions |
| `investment-portfolio-advisor-short-term-memory-tutorial.ipynb` | Finance | Client profiling, portfolio recommendations |
