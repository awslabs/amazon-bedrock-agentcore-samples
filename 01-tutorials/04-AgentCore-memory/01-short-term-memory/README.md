...
| LangGraph     | Support Agent   | Customer support agent with human-in-the-loop capabilities for complex issue resolution               | [support-agent-human-in-the-loop.ipynb](./01-single-agent/with-langgraph-agent/support-agent-human-in-the-loop.ipynb) | [View](./01-single-agent/with-langgraph-agent/architecture.png) |
| LangGraph     | Math Agent      | Mathematical problem-solving agent with multi-step persistence for complex calculations                | [math-agent-with-multi-step-persistence.ipynb](./01-single-agent/with-langgraph-agent/math-agent-with-multi-step-persistence.ipynb) | [View](./01-single-agent/with-langgraph-agent/architecture.png) |
