...
| 03 | [Wallet Operations](03-user-onboarding-wallet-funding/) | Wallet integration | Full wallet lifecycle: onboard additional users, funding options (testnet faucet and production onramps), delegation per provider, balance checks, multi-network wallets, and session budget patterns |
