...
| 06 | [Research agent with payment memory](00-getting-started/06-research-agent-with-payment-memory/) | Combine AgentCore payments with AgentCore Memory to recall past data and optimize spend across sessions |
