...
| `cloudwatch-urls.txt` | `scripts/` | CloudWatch dashboard and X-Ray URLs | `setup_cloudwatch.sh` |
| `xray-permissions.json` | `scripts/` | IAM policy for X-Ray permissions | `setup_cloudwatch.sh` |
