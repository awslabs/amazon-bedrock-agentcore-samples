...
def cleanup_lab_03(region_name: str = "us-west-2", verbose: bool = True) -> None:
                ...
                try:
                    ...
                    if "ResourceNotFoundException" not in error_str:
                        ...
                        if "bedrock-agentcore-identity" in error_str:
                            ...
                            print(f"  ⚠ Failed to delete secret {secret_name}: {error_str}")  # codeql[py/clear-text-logging-sensitive-data]
        else:
    ...
    try:
        ...
        runtime_name_patterns = ["aiml301_sre_agentcore_remediation_runtime", "remediation_runtime", "remediation-runtime"]  # noqa: F841
