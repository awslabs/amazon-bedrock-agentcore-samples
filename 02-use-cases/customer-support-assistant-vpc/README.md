...
./cleanup.sh --delete-s3

```

> [!WARNING]
> Amazon Bedrock AgentCore Runtime create's [ENI](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-eni.html) in the VPC, these VPC's take ~ 8 hours to delete, please manully delete the VPC stacks after the ENI are automatically removed by the service.
