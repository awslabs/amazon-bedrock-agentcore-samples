...
def forecast_budget_overrun(budget_name: str) -> str:
    ...
    try:
        ...
        if risk_level in ["MEDIUM", "HIGH"]:
            ...
            if risk_level == "HIGH":
                results["recommendations"].append("Immediate action required to prevent significant overrun")
...
def calculate_burn_rate(time_period: str = "LAST_7_DAYS") -> str:
    ...
    try:
        ...
        second_half_avg = sum(daily_costs[mid_point:]) / (len(daily_costs) - mid_point) if mid_point > 0 else 0
