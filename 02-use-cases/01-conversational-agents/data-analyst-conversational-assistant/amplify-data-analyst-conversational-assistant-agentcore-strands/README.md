...
If this project is inside a monorepo, set the environment variable `AMPLIFY_MONOREPO_APP_ROOT` to `02-use-cases/01-conversational-agents/data-analyst-conversational-assistant/amplify-data-analyst-conversational-assistant-agentcore-strands`.
