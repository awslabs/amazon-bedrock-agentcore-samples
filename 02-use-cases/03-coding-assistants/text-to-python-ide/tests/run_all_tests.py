...
class TestRunner:
    ...
    def start_backend(self):
        ...
        backend_process = subprocess.Popen(
            [sys.executable, "backend/main.py"], cwd=project_root, stdout=subprocess.PIPE, stderr=subprocess.PIPE
        )
        ...
        try:
            ...
            with code_session("us-east-1") as code_client:
                response = code_client.invoke(
                    "executeCode",
                    {"code": 'print("AgentCore test successful")', "language": "python", "clearContext": True},
                )
