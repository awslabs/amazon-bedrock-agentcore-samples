...
If this project is inside a monorepo, set the environment variable `AMPLIFY_MONOREPO_APP_ROOT` to `02-use-cases/video-games-sales-assistant/amplify-video-games-sales-assistant-agentcore-strands`.
...
| `APP_DESCRIPTION` | No | Subtitle on the sign-in page | `Video Games Sales Data Analyst powered by Amazon Bedrock AgentCore` |
