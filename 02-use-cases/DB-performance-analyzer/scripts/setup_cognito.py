...
def main():
    ...
    print(
        f"Discovery URL: {cognito_result['authorizer_config']['customJWTAuthorizer']['discoveryUrl']}"
    )
...
"""
    ...
    print(
        f"Saved Cognito configuration to {os.path.join(current_dir, 'config/cognito_config.env')}"
    )
