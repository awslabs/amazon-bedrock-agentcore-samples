    ...
    try:
        async with httpx.AsyncClient(
            ...
            resolver = A2ACardResolver(
                httpx_client=httpx_client, base_url=coordinator_url
            )
            ...
            httpx_client.headers["X-Amzn-Bedrock-AgentCore-Runtime-Session-Id"] = (
                session_id
            )
            ...
            if response_text:
                ...
                if any(
                    ...
                    for keyword in ["apartment", "property", "new york", "rent", "$"]
                ):
                    print("\n✅ Response contains property search results!")
                    print(
                        "✅ Coordinator successfully called search agent and returned results"
                    )
                else:
                    print(
