...
async def cart_manager(query: str, user_id: str = "", session_id: str = ""):
    ...
    - add_to_cart(user_id, items): Add products - items list requires asin (product_id), title, price
    ...
    try:
        ...
        - add_to_cart(user_id="{user_id}", items=[{{"asin": "product_id_123", "title": "Product", "price": "$10", "item_type": "product"}}])
        ...
        NOTE: For products from Google Shopping, the product_id is stored in the 'asin' field for compatibility.
