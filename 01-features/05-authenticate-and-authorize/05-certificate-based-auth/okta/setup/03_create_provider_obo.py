...
def main() -> None:
    ...
    print(f"    Grant type used   : urn:ietf:params:oauth:grant-type:token-exchange")
    print(f"    actorTokenContent : NONE  (no actor_token → no RFC 8693 'act' claim)")
    print()
    ...
    print(f"    the RFC 8693 exchange. The subject_token is a user JWT; Okta")
    print(f"    returns a new access token whose 'sub' is the user but whose")
    print(f"    'cid' is your service app - the shape that makes 'call this")
    print(f"    downstream API on the user's behalf' work cleanly.")
    print()
    print(f"  Next steps:")
