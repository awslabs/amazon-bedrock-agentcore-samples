...
- **[06-getting-started-with-agent-inspector](../06-getting-started-with-agent-inspector)** — the default (Converse) harness + Agent Inspector walkthrough this builds on.
